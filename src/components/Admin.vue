...
export default {
    ...
    data: () => ({
        valid: true,
        items: [
            { text: 'Carros', icon: 'mdi-car', isActive: false },
            { text: 'Modelos', icon: 'mdi-zip-box', isActive: true },
            { text: 'Marcas', icon: 'mdi-watermark', isActive: false },
            { text: 'Usuários', icon: 'mdi-account', isActive: false },
            { text: 'Opcionais', icon: 'mdi-format-list-bulleted', isActive: false },
            { text: 'Plataformas', icon: 'mdi-magnify', isActive: false },
            { text: 'Cores', icon: 'mdi-format-color-fill', isActive: false },
            { text: 'Combustível', icon: 'mdi-gas-station', isActive: false },
            { text: 'Motorização', icon: 'mdi-cog-box', isActive: false },
            { text: 'Sair', icon: 'mdi-logout', isActive: false },
    ...
    methods: {
        ...
        deleteItemConfirm() {
            ...
            axios.delete(`https://posdblucas.herokuapp.com/api/models/${this.editedItem.id_model}`, this.editedItem).then(() => {
                this.initialize();
        ...
        save() {
            ...
            if (this.valid == true) {
                if (this.editedIndex > -1) {
                    axios.patch(`https://posdblucas.herokuapp.com/api/models/${this.editedItem.id_model}`, this.editedItem).then(() => {
                        this.initialize();
                        this.typeAlert = "success";
                    ...
                    axios
                        .post('https://posdblucas.herokuapp.com/api/models', this.editedItem).then((res) => {
                            console.log(res);
                            this.initialize();
                            this.typeAlert = "success";
